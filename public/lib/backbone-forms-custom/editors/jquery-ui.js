;(function(Form) {
  ...
  exports['jqueryui.Date'] = Base.extend({
    ...
    render: function() {
      ...
      $el.html('<input class="form-control">');
  ...
  exports['jqueryui.DateTime'] = exports['jqueryui.Date'].extend({
    ...
    template: _.template('<select class="input-group-addon form-control" style="width:65px;"><%=hours%></select><select class="form-control input-group-addon" style="width: 65px;"><%=mins%></select>', null, Form.templateSettings),
    ...
    render: function() {
      ...
      $('<div class="input-group"></div>').appendTo (this.$el);
      var input_el = $('input', this.$el);
      input_el.css ('width', '40%');
      var input_group = $('.input-group', this.$el);
      input_el.detach ().appendTo (input_group);
      ...
      //Render time selects
      input_group.append(this.template({
